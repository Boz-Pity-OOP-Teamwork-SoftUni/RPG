...
namespace RolePlayingGame
{
    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            Character hero = new Hero("1", new Position(1,1), "pesho", 10, 200, 300, 24, 1.5, 15, 1);
            Character monster = new Monster("23", new Position(2,3), "gosho", 150, 50, 30, 13.5, 1.3, 20, 3, 100);
